...
MONGO_COLLECTION="prepayments"
ORACLE_USER = "stage"
ORACLE_PASS = "stage"
ORACLE_DSN = "172.18.24.84/orcl"
DEST_TABLE_NAME= 'credit_prepayments'
...
timestamp_column_names=["creationDate","expirationDate","creditRelayDate","finalizeDate","modificationDate"]
